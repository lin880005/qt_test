...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.add.setGeometry(QtCore.QRect(330, 340, 60, 30))
        ...
        self.pic.setGeometry(QtCore.QRect(80, 50, 110, 100))
        self.pic.setText("")
        ...
        self.checkBox.setGeometry(QtCore.QRect(210, 60, 110, 40))
        self.checkBox.setObjectName("checkBox")
        self.comboBox = QtWidgets.QComboBox(Dialog)
        self.comboBox.setGeometry(QtCore.QRect(340, 10, 110, 40))
        self.comboBox.setObjectName("comboBox")
        self.hello = QtWidgets.QPushButton(Dialog)
        self.hello.setGeometry(QtCore.QRect(180, 350, 56, 17))
        self.hello.setObjectName("hello")
        self.progressBar = QtWidgets.QProgressBar(Dialog)
        self.progressBar.setGeometry(QtCore.QRect(140, 280, 240, 40))
        self.progressBar.setProperty("value", 24)
        self.progressBar.setObjectName("progressBar")
        self.horizontalSlider = QtWidgets.QSlider(Dialog)
        self.horizontalSlider.setGeometry(QtCore.QRect(140, 220, 240, 20))
        self.horizontalSlider.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider.setObjectName("horizontalSlider")
        self.horizontalSlider_2 = QtWidgets.QSlider(Dialog)
        self.horizontalSlider_2.setGeometry(QtCore.QRect(60, 20, 160, 16))
